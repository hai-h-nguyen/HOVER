...
from . import neural_wbc_env_cfg_g1, neural_wbc_env_cfg_h1, neural_wbc_env_cfg_h12, neural_wbc_env_cfg_h12_almi
...
gym.register(
    id="NeuralWBC-H12-ALMI-v0",
    entry_point="neural_wbc.isaac_lab_wrapper.neural_wbc_env:NeuralWBCEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": neural_wbc_env_cfg_h12_almi.NeuralWBCEnvCfgH12_ALMI,
    },
)
